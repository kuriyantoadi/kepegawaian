      ...
      <div class="col-12 col-md-12 col-xxl-6 d-flex order-3 order-xxl-2">
        <div class="card flex-fill w-100">
          ...
          <div class="card-body px-4">
            <center>
              <h3 style="margin-top: 30px; margin-bottom: 20px">Tambah Berkas Naik Gaji Pegawai Negeri Sipil</h3>
            </center>

            <?= form_open_multipart('C_file/naik_pangkat_tambah_up'); ?>
            ...
            <div class="mb-3">
              <label class="form-label"><b>File Upload</b></label>
              <input type="file" class="form-control" name="nama_file" required>
              <p>File yang di ijinkan pdf dan maksimal file 2 MB</p>
            </div>
