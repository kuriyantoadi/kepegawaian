            ...
            $no=1;
             ...
             ?>
              <tr>
                ...
                <!-- <td><center><span class="badge bg-primary">Primary</span><?= $row->status_validasi ?></td> -->
                <td><center>
                ...
                <td><center>
                  ...
                  <a href="<?= site_url('C_operator/validasi_naik_gaji_lihat/'.$row->id_file); ?>" class='btn btn-info btn-sm'>View</a>
                </td>
              </tr>
            <?php }  ?>
            </table>
