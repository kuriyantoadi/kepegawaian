      ...
      <div class="col-12 col-md-12 col-xxl-6 d-flex order-3 order-xxl-2">
        <div class="card flex-fill w-100">
          ...
          <div class="card-body px-4">
            <center><h3 style="margin-bottom: 40px;">Berkas Tunjangan Keluarga Pegawai Negeri Sipil</h3></center>
             ...
             ?>
              <tr>
                ...
                <td><center>
                  ...
                  <a href="<?= site_url('C_operator/validasi_tunjangan_lihat/'.$row->id_file); ?>" class='btn btn-info btn-sm'>View</a>
                </td>
              </tr>
            <?php }  ?>
            </table>
