      ...
      <div class="col-12 col-md-12 col-xxl-6 d-flex order-3 order-xxl-2">
        <div class="card flex-fill w-100">
          ...
          <div class="card-body px-4">
            ...
            <center>
             <a href="<?= site_url('C_operator/validasi_naik_gaji_tolak/'.$row->id_file); ?>" class='btn btn-danger'>Tolak</a>
             <a href="<?= site_url('C_operator/validasi_naik_gaji_terima/'.$row->id_file); ?>" class='btn btn-info'>Terima</a>
